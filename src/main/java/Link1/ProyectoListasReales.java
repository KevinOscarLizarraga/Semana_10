...
/*1. Crear un programa que use ArrayList de números reales. 
El programa debe permitir mostrar un menú donde se pueda agregar un número,
buscar un número, modificar un número,eliminar un número e insertar un 
número en una posición dada*/
public class ProyectoListasReales {

    ArrayList<Double> listaReales;

    public static void main(String[] args) {
        ProyectoListasReales proyectoReales = new ProyectoListasReales();
    ...
    public void buscarValor() {
        ...
        if (indice != -1) {System.out.println("Dato se encuentra en posicion: " + indice);
        } else {
